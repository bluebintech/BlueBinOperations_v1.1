    ...
    <asp:TableCell Width="500px"  BorderColor="#032169" BorderStyle="Solid" BorderWidth="1">
        ...
        <asp:Table ID="Table1" runat="server" CellPadding="10" Width="500px" BorderWidth="10" BorderColor="#CCEEFF" BackColor="#CCEEFF">
            ...
            <asp:TableRow>    
                ...
                <asp:TableCell>
                    <asp:TextBox ID="CustomerTB" runat="server"  ReadOnly="True" BackColor="#CCEEFF" Width="100px" Text="MHS"></asp:TextBox>
                 </asp:TableCell>
            </asp:TableRow> <asp:TableRow Height="10"></asp:TableRow>
            ...
            <asp:TableRow>    
                ...
                <asp:TableCell>
                    <asp:Table>
                                 <asp:TableRow>
                                <asp:TableCell><asp:DropDownList ID="Item1DD"  AppendDataBoundItems="true" runat="server" DataSourceID="ItemSource" DataTextField="ItemDescription" DataValueField="ItemDescription"  AutoPostBack="False">
