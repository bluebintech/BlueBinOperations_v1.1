<%@ Page Title="Gemba Audit Node Form" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="GembaAuditNodeFormEdit.aspx.vb" Inherits="GembaAuditNodeFormEdit" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">

<asp:Table ID="PageTable" runat="server" Width="1250px"  Height ="800px" align = "center">
<asp:TableRow><asp:TableCell><h2>Gemba Audit Node - Edit</h2></asp:TableCell><asp:TableCell></asp:TableCell></asp:TableRow>
<asp:TableRow>
<asp:TableCell Width="400px" Height="900px" BorderColor="#0099CC" BorderStyle="Solid" BorderWidth="1">
...
<%-- ***************--%>   
 ...
 <%-- ID (For Update Form Only) --%>   
                ...
                <asp:TableCell Width="100px">
                    <asp:Label ID="LabelGembaAuditNodeID" runat="server" Text="Node Audit #" Width="100px" BackColor="#CCEEFF"></asp:Label>
                </asp:TableCell>
                <asp:TableCell Width="300px">
                    <asp:TextBox ID="GembaAuditNodeIDTB" runat="server"  ReadOnly="True" BackColor="#CCEEFF" Width="100px"></asp:TextBox>
                </asp:TableCell>
...
<%-- Date --%>   
                <asp:TableRow Width="40px">    
                <asp:TableCell Width="100px">
                    <asp:Label ID="Label1" runat="server" Text="Date Entered" Width="100px" BackColor="#CCEEFF"></asp:Label>
                </asp:TableCell>
                <asp:TableCell Width="300px">
...
<%-- ***************--%>    
            ...
            <asp:TableRow Width="850px" BackColor="#333333">    
                ...
                <asp:TableRow>
                    ...
                    <asp:RadioButtonList id=PS_EmptyBinsRL runat="server" RepeatDirection="Horizontal" RepeatLayout="Table" CssClass="fixWidth18" RepeatColumns="6">
                            <asp:ListItem Value="0">5 or More</asp:ListItem>
 ...
 <%-- Replenishment Standards --%>   
            ...
            <asp:TableRow Width="850px" BackColor="#333333" Height="15">    
                ...
                <asp:TableRow>
                    ...
                    <asp:RadioButtonList id=RS_NodeSweptRL runat="server" RepeatDirection="Horizontal" RepeatLayout="Table" CssClass="fixWidth18" RepeatColumns="3">
                            <asp:ListItem Value="0">In Need</asp:ListItem>
            ...
            <asp:TableRow>
                    <asp:TableCell>&nbsp;<asp:Label ID="Label12" runat="server" Text="Other Node ServiceCorrections"></asp:Label></asp:TableCell>
                    <asp:TableCell>
...
<%-- Node Integrity Standards --%>   
 ...
 <asp:TableRow>
     <asp:TableCell>
        ...
        <asp:SqlDataSource ID="GembaAuditNodeFormAuditerResourceSource" runat="server" ConnectionString="<%$ ConnectionStrings:Site_ConnectionString %>" SelectCommand="SELECT LastName + ', ' + FirstName + ' (' + Login + ')' as FullName FROM [bluebin].[BlueBinResource]"></asp:SqlDataSource>
        <asp:SqlDataSource ID="GembaAuditNodeFormShadowResourceSource" runat="server" ConnectionString="<%$ ConnectionStrings:Site_ConnectionString %>" SelectCommand="SELECT LastName + ', ' + FirstName + ' (' + Login + ')' as FullName FROM [bluebin].[BlueBinResource]"></asp:SqlDataSource>
