...
<asp:TableCell Width="900px">  
    ...
    <p>
        <asp:Button ID="GembaAuditNodeFormButton" runat="server"  class="btn btn-primary btn-lg" Text="New Gemba Audit Node" /> &nbsp; 
    </p>
    <p>
...
<asp:TableRow><asp:TableCell><h2>Stage Audits</h2></asp:TableCell></asp:TableRow>
<asp:TableRow>
<asp:TableCell Width="900px">  
    
    <p>
        <asp:Button ID="GembaAuditStageFormButton" runat="server"  class="btn btn-primary btn-lg" Text="New Gemba Audit Stage" /> &nbsp; 


    </p>
    
        <p>
   <asp:GridView  CssClass="GridViewitem" ID="GembaAuditStageGridView"  OnRowDataBound="OnRowDataBoundStage" runat="server" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataSourceID="GembaAuditStageSource" GridLines="Vertical" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="GembaAuditStageID" RowStyle-HorizontalAlign="Center" RowStyle-Wrap="False" HeaderStyle-HorizontalAlign="Center">
        <AlternatingRowStyle BackColor="#DCDCDC" />
        <Columns>
            
            <asp:HyperLinkField DataNavigateUrlFields="GembaAuditStageID" DataNavigateUrlFormatString="GembaAuditStageFormEdit.aspx?GembaAuditStageID={0}" Text="Edit"></asp:HyperLinkField>
           <asp:BoundField DataField="GembaAuditStageID" HeaderText="GembaAuditStageID" InsertVisible="False" ReadOnly="True" SortExpression="GembaAuditStageID" Visible="False" />
            <asp:BoundField DataField="Date" HeaderText="Audit Date" SortExpression="Date" DataFormatString="{0:d}" />
            <asp:BoundField DataField="LastUpdated" HeaderText="Last Updated" SortExpression="LastUpdated"  Visible="False" DataFormatString="{0:d}" />
            <asp:BoundField DataField="Auditer" HeaderText="Auditer" ReadOnly="True" SortExpression="Auditer" />
            <asp:BoundField DataField="AuditerLogin" HeaderText="AuditerLogin" ReadOnly="True" SortExpression="AuditerLogin"  Visible="False" />
            <asp:BoundField DataField="KanbansFilled" HeaderText="Kanbans Filled?" SortExpression="KanbansFilled" />
            <asp:BoundField DataField="ReqsSubmitted" HeaderText="Reqs Submitted?" SortExpression="ReqsSubmitted" />
            <asp:BoundField DataField="BinsInOrder" HeaderText="Bins In Order?" SortExpression="BinsInOrder" />
            <asp:BoundField DataField="AreaNeatTidy" HeaderText="Area Neat Tidy?" SortExpression="AreaNeatTidy" />
            <asp:BoundField DataField="CartsClean" HeaderText="Carts Clean?" SortExpression="CartsClean"/>
            <asp:BoundField DataField="AdditionalCommentsStageText" HeaderText="AdditionalCommentsStageText" SortExpression="AdditionalCommentsStageText"  Visible="False"/>
            <asp:BoundField DataField="AdditionalCommentsStage" HeaderText="Addtl Comments" SortExpression="AdditionalCommentsStage" />
            <asp:BoundField DataField="ConcernsText" HeaderText="ConcernsText" SortExpression="ConcernsText"  Visible="False"/>
            <asp:BoundField DataField="Concerns" HeaderText="Concerns" SortExpression="Concerns" />
              <asp:TemplateField ShowHeader="False">
             <ItemTemplate>
            <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Delete" OnClientClick="return confirm('Are you sure you want to delete this entry?');">Delete</asp:LinkButton>             
            </ItemTemplate>
     ...
     <p>
        <asp:ImageButton ID="GembaAuditStageExportToExcelImageButton" runat="Server" ImageUrl="~/img/ExportExcel.gif" OnClick="GembaAuditStageExportToExcel" Height="25px" />
    </p>
...
<asp:SqlDataSource ID="GembaAuditStageSource" runat="server" ConnectionString="<%$ ConnectionStrings:Site_ConnectionString %>" 
    SelectCommand="exec sp_SelectGembaAuditStage" DeleteCommand="exec sp_DeleteGembaAuditStage @GembaAuditStageID  " >
