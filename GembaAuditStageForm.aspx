<%@ Page Title="Gemba Audit Stage Form" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="GembaAuditStageForm.aspx.vb" Inherits="GembaAuditStageForm" %>
...
<asp:TableRow>
    <asp:TableCell Width="900px"  BorderColor="#032169" BorderStyle="Solid" BorderWidth="1">
        ...
        <asp:Table ID="Table1" runat="server" CellPadding="10" Width="900px" BorderWidth="10" BorderColor="#CCEEFF" BackColor="#CCEEFF">
            ...
            <asp:TableRow Width="900px">    
                <asp:TableCell Width="350px">
                    <asp:Label ID="LabelCurrentTime" runat="server" Text="Date" Width="100px" BackColor="#CCEEFF"></asp:Label>
                </asp:TableCell>
                <asp:TableCell Width="50px">
                </asp:TableCell>
                <asp:TableCell Width="100px">
                    <asp:TextBox ID="CurrentTime" runat="server"  ReadOnly="True" BackColor="#CCEEFF" DataFormatString="{0:d}" Width="100px"></asp:TextBox>
                </asp:TableCell>
                <asp:TableCell Width="350px">
                </asp:TableCell>
            </asp:TableRow><asp:TableRow Height="10"></asp:TableRow>
            ...
            <asp:TableRow Width="900px">
                ...
                <asp:TableCell Width="100px">
                    <asp:TextBox ID="OldestBinTB" runat="server" Width="130px" TextMode="Date"></asp:TextBox> 
                </asp:TableCell>
                <asp:TableCell Width="350px">
                </asp:TableCell>
            </asp:TableRow><asp:TableRow Height="10"></asp:TableRow>
    ...
    <br />&nbsp;&nbsp; <br /><br /><br /><br /><br />
        <asp:SqlDataSource ID="GembaAuditStageFormLocationSource" runat="server" ConnectionString="<%$ ConnectionStrings:Site_ConnectionString %>" SelectCommand="SELECT LocationID,LocationName FROM [bluebin].[DimLocation] where BlueBinFlag = 1"></asp:SqlDataSource>      
