...
<p>Welcome to the Learning and Documentation Page for BlueBin Operations.  You will find Documentation pertaining to the BlueBin Program in the form of Presentations, Guides, and Specifications.</p>
    ...
    <div>
        ...
        <a href="/BlueBinDocuments/BBI Module #2 - 5S.ppsx" runat="server" target="_blank">5S - Workplace Organization Overview</a><br />
        <a href="/BlueBinDocuments/BBI Module #3 - STANDARD WORK.ppsx" runat="server" target="_blank">Standard</a><br />
        <a href="/BlueBinDocuments/BBI Module #4 - FLOW.ppsx" runat="server" target="_blank">Flow - Operational Efficiency</a><br />
    </div>
    <div>
