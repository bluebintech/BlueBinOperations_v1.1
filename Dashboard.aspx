          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="themes">
                            ...
                            <li><a href="#" onClick="switchView('Node Volume')">Node Volume</a></li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="download2">
                			<li><a href="#" onClick="switchView('Medical Supply Spend')">Medical Supply Spend</a></li>
...
var url = "https://10ay.online.tableau.com/#/site/bluebinanalytics/views/MHS/Home";
var options = {
   hideTabs: true,
   hideToolbar: true,
   width: "100%",   
