...
<asp:TableCell Width="900px">  
    ...
    <p>
    <p>
        <asp:GridView  CssClass="GridViewitem" ID="GridView1" DataKeyNames="POID"  runat="server" AllowSorting="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataSourceID="SqlDataSource1" GridLines="Vertical" AllowPaging="True" RowStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" CellSpacing="3">
...
inner join Vendor v on a.VendorID = a.VendorID
where c.CustomerName = 'MHS'" UpdateCommand="UPDATE [PO] SET [PO] = @PO, [CustomerID] = (Select CustomerID from Customer where CustomerName = @CustomerName), [VendorID] = (select VendorID from Vendor where VendorName = @VendorName), [Total] = @Total, [OrderDate] = @OrderDate WHERE [POID] = @POID">
            <DeleteParameters>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:BlueBinHardwareConnectionString %>" SelectCommand="SELECT DISTINCT [VendorName] FROM [Vendor]"></asp:SqlDataSource>
            ...
            <p>
                ...
                <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:BlueBinHardwareConnectionString %>" SelectCommand="SELECT 
