...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="jumbotron">
        ...
        <h1>BlueBin Operations Application</h1>
         <p class="lead">Hello&nbsp;<asp:LoginName ID="LoginName2" runat="server" Font-Bold = "true" /> and welcome to the BlueBin Operations Application (BBOpApp) for your Facility!&nbsp; Please click below to learn more about the setup of this application and for other documentation.</p>
    ...
    <div class="row">        <div class="col-md-4">
      ...
      <div class="col-md-4">
        ...
        <div class="col-md-4">
            ...
            <p>
                Review Site Configuration for your BlueBin Solution and change based on your needs.
            </p>
            <p>
                <a class="btn btn-default" runat="server" href="~/SiteConfiguration">Click Here &raquo;</a>
            </p>
