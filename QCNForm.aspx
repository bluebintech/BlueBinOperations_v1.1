        ...
        <asp:Table ID="Table1" runat="server" CellPadding="10" Width="500px" BorderWidth="10" BorderColor="#CCEEFF" BackColor="#CCEEFF">
            ...
            <asp:TableRow>    
                <asp:TableCell>
                    ...
                    <asp:DropDownList ID="ClinicalDescriptionDD" runat="server"  AppendDataBoundItems="false"  DataTextField="ItemClinicalDescription" DataValueField="ItemID" DataSourceID="ClinicalDSource">
                                        <asp:ListItem Selected = "True" Text = "--Select--" Value = ""></asp:ListItem>
